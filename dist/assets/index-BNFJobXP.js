...
<div class="max-w-5xl mx-auto px-4 md:px-6">
  ...
  ">
    ...
    <div class="flex flex-col md:flex-row gap-4 md:gap-6 items-start">
      ...
      <p
        id="history-text"
        data-text="${e?`本中心的行政大樓歷經多年規劃與設計，最終於 2020 年正式落成啟用。其建置過程凝聚了長期的研究發展需求與制度性規劃，象徵中心在研究能量與組織規模上的穩定成長。隨著大樓啟用，本中心也進一步強化資料整合與跨領域研究的基礎，持續推動台灣人類多樣性研究的深化與延展。`:`The center's administration building was completed after years of planning and officially inaugurated in 2020.`}"
        class="leading-relaxed opacity-80 text-base md:text-lg"
      ></p>
    </div>
  </div>
